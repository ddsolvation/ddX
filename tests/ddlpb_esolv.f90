...
default_epsilon = (/ -4.7522067624830968E-004, -9.7114460382619419E-004, &
                   & -1.0299850847338599E-003, -1.0359894279163145E-003 /)
!eta : 0.0001, 0.001, 0.01, 0.1
default_eta = (/ -1.0144763156304561E-003, -1.0144763156304561E-003, &
               & -1.0144838337538293E-003, -1.0196804425703918E-003 /)
!kappa : 0.5, 0.25, 0.16667, 0.125
default_kappa = (/ -1.0287405759052844E-003, -1.0244866636983348E-003,&
                 & -1.0220417037372237E-003, -1.0205199125633672E-003 /)
!lmax : 2, 4, 8, 16
default_lmax = (/ -1.0123387463246817E-003, -1.0195474390235462E-003, &
                & -1.0196195479841262E-003, -1.0172906575039258E-003 /)
...
subroutine check_values(default_value, computed_value)
    ...
    do i = 1, 4
      if(abs(default_value(i) - computed_value(i)) .gt. 1d-6) then
        write(*,*) 'Issue in values, default : ', default_value(i), ', computed : ',&
                  & computed_value(i)
        stop 1
      endif
    end do
