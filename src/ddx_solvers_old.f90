...
!
!---------------------------------------------------------------------------------------------
subroutine jacobi_diis_old(params, constants, workspace, n, lprint, diis_max, norm, tol, rhs, x, n_iter, &
...
!
!         compute norm
          rms_norm_diff = u_norm(params, constants, workspace, x )
          rms_norm = u_norm(params, constants, workspace, x_new )
!
!         check norm
          ok = (rms_norm_diff .lt. tol*rms_norm)
!          
