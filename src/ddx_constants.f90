...
type ddx_constants_type
    ...
    !> LPB Bessel function of the first kind. Dimension is (lmax+2, nsph).
...
subroutine constants_init(params, constants, info)
    ...
    if (params % model .eq. 3) then
        ...
        allocate(constants % SI_ri(0:params % lmax+1, params % nsph))
        allocate(constants % DI_ri(0:params % lmax+1, params % nsph))
        ...
        do isph = 1, params % nsph
            ...
            call modified_spherical_bessel_first_kind(params % lmax+1, &
